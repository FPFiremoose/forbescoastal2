...
<section>
	<div class="flex flex-row justify-center gap-10 bg-sky p-24">
		<Benefit heading="Personalized Process"
		...
		>
		<Benefit heading="Meticulously Crafted"
		...
		>
		<Benefit heading="Indoor and Outdoor Harmony"
